...
Desde a versão 3.5.0 **[TO BE CONFIRMED]** do Middleware a morada é lida a partir dos serviços centrais 
o que implica ligação à Internet funcional para a utilização da classe `PTEID_Address`.
...
| ------------------------------------- | -------------------------------------------------- |
|  EIDMW_REMOTEADDR_CONNECTION_ERROR    | Erro de ligação ao serviço de leitura de morada (devido a conectividade ou erro no handshake TLS )|
